...
local ANIMATION_SPECS = {
    ...
    GlowingGems = {
        {
            ...
            type    = "corner_gems",
            texture = ROOT_PATH .. "waypoint\\GlowingGemsPlaque_Gems",
            texW    = 512,
            texH    = 256,
            srcL    = 20,
            srcT    = 18,
            ...
            glow    = {
                texture   = ROOT_PATH .. "waypoint\\Glow",
                size      = 12,
                speed     = math.pi,
                amplitude = 0.15,
                base      = 0.15,
    ...
    HordePlaque = {
        {
            type    = "full_overlay",
            texture = ROOT_PATH .. "waypoint\\HordePlaqueAnimation",
            pulse   = {
                speed = 3.5,
                amplitude = 0.30,
                base = 0.82,
    ...
    AlliancePlaque = {
        {
            type    = "full_overlay",
            texture = ROOT_PATH .. "waypoint\\AlliancePlaqueAnimation",
            pulse   = {
                speed = 3.5,
                amplitude = 0.30,
                base = 0.82,
    ...
    SteamPunkPlaque = {
        {
            type    = "full_overlay",
            texture = ROOT_PATH .. "waypoint\\SteamPunkPlaqueAnimation",
            pulse   = {
                speed = 3.5,
                amplitude = 0.30,
                base = 0.82,
...
--
-- Fills result with:
--   result.Gems         — gems frame (has __zwpTextures, SetVertexColor,
...
local function BuildCornerGems(parent, panelFrame, animSpec, plaqueType, result)
    ...
    local function addGem(name, uvL, uvR, uvT, uvB, point, px, py)
        ...
        gems[name] = tex
        gems.__zwpTextures[#gems.__zwpTextures + 1] = tex
    end
