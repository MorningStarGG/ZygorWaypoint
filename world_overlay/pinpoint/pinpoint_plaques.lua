...
local PLAQUE_SPECS = {
    ...
    GlowingGems = {
        ...
        texture = PLAQUE_PATH .. "GlowingGemsPlaque",
    ...
    HordePlaque = {
        texture = PLAQUE_PATH .. "HordePlaque",
        texW    = 512,
        texH    = 256,
    ...
    AlliancePlaque = {
        texture = PLAQUE_PATH .. "AlliancePlaque",
        texW    = 512,
        texH    = 256,
    ...
    Default = {
        texture = PLAQUE_PATH .. "BasicFantasyPlaque",
        texW    = 512,
        texH    = 256,
    ...
    ModernPlaque = {
        texture = PLAQUE_PATH .. "ModernPlaque",
        texW    = 512,
        texH    = 256,
    ...
    SteamPunkPlaque = {
        texture = PLAQUE_PATH .. "SteamPunkPlaque",
        texW    = 512,
        texH    = 256,
...
M.Plaques = {
    ...
    -- The panel has:
    --   panel.__awpTextures       — all 9 texture pieces (for iterative tinting)
    ...
    CreatePanel = function(parent, plaqueType)
        ...
        panel.__awpPlaqueType = resolvedPlaqueType
        panel.__awpPlaqueSpec = spec
