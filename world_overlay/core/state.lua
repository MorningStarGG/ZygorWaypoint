...
NS.Internal.WorldOverlay = NS.Internal.WorldOverlay or {}

local M = NS.Internal.WorldOverlay

---@class AWPWorldOverlayTarget
...
state.WorldOverlay = state.WorldOverlay or {
    ...
    -- Seeded host target / surrogate state
    seededHostMapID = nil,
    seededHostX = nil,
    seededHostY = nil,
    seededHostSig = nil,
    surrogateActive = false,
    surrogateTargetSig = nil,
    surrogateRealDistance = nil,
    lastSurrogateSeedAt = 0,
    lastSurrogateWorldX = nil,
    lastSurrogateWorldY = nil,
    -- Host position
    hostMapID = nil,
    hostX = nil,
    hostY = nil,
    routeProbeSig = nil,
    routeProbePlayerMapID = nil,
    routeProbeValid = nil,
    routeProbeMode = nil,
    lastEnsureSig = nil,
    lastEnsureMapID = nil,
    ...
    -- Base offset (live value written by UpdateWaypointVisual each tick)
    currentBottomOffsetAdjust = 0,
}
...
local function InvalidateFrameVisuals(entry)
    ...
    entry.beaconStyle = nil
    entry.beaconColumnFadeAlpha = nil
    entry.contextScale = nil
    entry.contextIconOffsetY = nil
    entry.beaconFrameOffsetY = nil
    entry.footerOffsetY = nil
    entry.anchorRef = nil
    entry.anchorX = nil
    entry.anchorY = nil
    entry.angle = nil
