...
local CASES = {
    ...
    },
    {
        ...
        category = "instruction_neighbor",
        classification = "approved_improvement",
        sourceNote = "LibTaxi npcid proof should classify as taxi even when subtext wording has no flight keywords.",
        currentGoalNum = 1,
        context = {
            rawArrowTitle = "Talk to Dungar Longdrink",
            kind = "route",
    ...
    },
    {
        ...
        category = "instruction_neighbor",
        classification = "approved_improvement",
        sourceNote = "'Begin Flying to' phrase should classify as taxi via text fallback when npcid has no LibTaxi proof.",
        currentGoalNum = 1,
        context = {
    ...
    },
    {
        ...
        category = "instruction_neighbor",
        classification = "approved_improvement",
        sourceNote = "Non-taxi NPC with generic subtext should NOT classify as taxi under structured-only proof policy.",
        currentGoalNum = 1,
        context = {
