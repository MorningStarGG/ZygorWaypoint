...
local function ResolveBackdropCompactState(parent, border, compact)
    ...
    local predicate = border and border._zwpBackdropCompactPredicate
...
local function GuardBackdrop(parent, border, compactPredicate)
    ...
    border._zwpBackdropParent = parent
    border._zwpBackdropCompactPredicate = compactPredicate

    if border._zwpBackdropHooked then
        return
    end
    ...
    hooksecurefunc(border, "SetBackdropColor", function(self, r, g, b, a)
        ...
        local backdropParent = self._zwpBackdropParent
